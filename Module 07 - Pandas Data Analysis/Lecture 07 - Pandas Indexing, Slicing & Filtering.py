...
# students.iloc[1:4,[0,2]]# when we want to skip a coloumn
...
students = pd.DataFrame({
    ...
    "Name":["Ali","Ahmed","Sara","Bilal","Usman","Umer"],

    "Marks":[82,74,91,68,87,82],

    "Department":["CS","AI","SE","DS","CS","EE"]
...
# )
# print(students[(students["Marks"]==82)&(students["Department"]=="EE")])
